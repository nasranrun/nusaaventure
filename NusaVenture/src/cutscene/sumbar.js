const dialogues = [
  {
    ...
    text: "Selamat datang di Sumatra barat! Saya akan jadi pemandu sekaligus teman perjalanan kakak hari ini. Sumatra barat punya banyak sekali adat istiadat dan budaya yang menarik. Yuk, saya ajak berkeliling sambil belajar."
  },
  {
    speaker: "../assets/img/cutscene_kepri.png",
    text: "Tentu, aku sudah tidak sabar untuk menjelajahi warisan kebudayaan milik Sumatra barat."
  },
  {
    speaker: "../assets/img/cutscene2.png",
    text: "Mari mau mulai dari mana?"
  }
];
