const dialogues = [
  {
    ...
    text: "Selamat datang di Kepulauan Riau! Saya akan jadi pemandu sekaligus teman perjalanan kakak hari ini. Kepulauan Riau punya banyak sekali adat istiadat dan budaya yang menarik. Yuk, saya ajak berkeliling sambil belajar."
  },
  {
    speaker: "../assets/img/cutscene_kepri.png",
    text: "Tentu, aku sudah tidak sabar untuk menjelajahi warisan kebudayaan milik Kepulauan Riau."
  },
  {
    speaker: "../assets/img/cutscene2.png",
