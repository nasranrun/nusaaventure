const dialogues = [
  {
    ...
    text: "Selamat datang di Nusa tenggara timur! Saya akan jadi pemandu sekaligus teman perjalanan kakak hari ini. Nusa tenggara timur punya banyak sekali adat istiadat dan budaya yang menarik. Yuk, saya ajak berkeliling sambil belajar."
  },
  {
    speaker: "../assets/img/cutscene_kepri.png",
    text: "Tentu, aku sudah tidak sabar untuk menjelajahi warisan kebudayaan milik Nusa tenggara timur."
  },
  {
    speaker: "../assets/img/cutscene2.png",
    text: "Mari kita mulai dari mana?"
  }
];
...
function showNextDialogue() {
  ...
  if (dialogueIndex >= dialogues.length) {
    window.location.href = "../pilihangame/ntt.html";
    return;
  }
