const dialogues = [
  {
    ...
    text: "Selamat datang di Maluku! Saya akan jadi pemandu sekaligus teman perjalanan kakak hari ini. Maluku punya banyak sekali adat istiadat dan budaya yang menarik. Yuk, saya ajak berkeliling sambil belajar."
  },
  {
    speaker: "../assets/img/cutscene_kepri.png",
    text: "Tentu, aku sudah tidak sabar untuk menjelajahi warisan kebudayaan milik Maluku."
  },
  {
    speaker: "../assets/img/cutscene2.png",
    text: "Mari, mau kita mulai dari mana?"
  }
];
