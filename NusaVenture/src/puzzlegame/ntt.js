const questions = [
  {
    preview: '../assets/img/pakaiansukusabuntt.png',
    pieces: [
      '../assets/img/sukusabuntt/puzzle_1_1.png',
      '../assets/img/sukusabuntt/puzzle_1_2.png',
      '../assets/img/sukusabuntt/puzzle_1_3.png',
      '../assets/img/sukusabuntt/puzzle_2_1.png',
      '../assets/img/sukusabuntt/puzzle_2_2.png',
      '../assets/img/sukusabuntt/puzzle_2_3.png',
      '../assets/img/sukusabuntt/puzzle_3_1.png',
      '../assets/img/sukusabuntt/puzzle_3_2.png',
      '../assets/img/sukusabuntt/puzzle_3_3.png'
    ],
    answer: [
      'puzzle_1_1.png','puzzle_1_2.png','puzzle_1_3.png',
      'puzzle_2_1.png','puzzle_2_2.png','puzzle_2_3.png',
      'puzzle_3_1.png','puzzle_3_2.png','puzzle_3_3.png'
    ],
    question: 'Apa Baju adat tradisional NTT pada gambar tersebut adalah '
  },
  {
    preview: '../assets/img/seidagingsapintt.png',
    pieces: [
      '../assets/img/seisapintt/puzzle_1_1.png',
      '../assets/img/seisapintt/puzzle_1_2.png',
      '../assets/img/seisapintt/puzzle_1_3.png',
      '../assets/img/seisapintt/puzzle_2_1.png',
      '../assets/img/seisapintt/puzzle_2_2.png',
      '../assets/img/seisapintt/puzzle_2_3.png',
      '../assets/img/seisapintt/puzzle_3_1.png',
      '../assets/img/seisapintt/puzzle_3_2.png',
      '../assets/img/seisapintt/puzzle_3_3.png'
    ],
    answer: [
      'puzzle_1_1.png','puzzle_1_2.png','puzzle_1_3.png',
      'puzzle_2_1.png','puzzle_2_2.png','puzzle_2_3.png',
    ...
    question: 'Apa makanan tradisional Khas NTT pada gambar tersebut 🍚'
  },
  {
    preview: '../assets/img/mbaruniangntt.jpeg',
    pieces: [
      '../assets/img/mbaruniangntt/piece_1_1.jpg',
      '../assets/img/mbaruniangntt/piece_1_2.jpg',
      '../assets/img/mbaruniangntt/piece_1_3.jpg',
      '../assets/img/mbaruniangntt/piece_2_1.jpg',
      '../assets/img/mbaruniangntt/piece_2_2.jpg',
      '../assets/img/mbaruniangntt/piece_2_3.jpg',
      '../assets/img/mbaruniangntt/piece_3_1.jpg',
      '../assets/img/mbaruniangntt/piece_3_2.jpg',
      '../assets/img/mbaruniangntt/piece_3_3.jpg'
    ],
    answer: [
      'piece_1_1.jpg','piece_1_2.jpg','piece_1_3.jpg',
      'piece_2_1.jpg','piece_2_2.jpg','piece_2_3.jpg',
      'piece_3_1.jpg','piece_3_2.jpg','piece_3_3.jpg'
    ],
    question: 'Apa Rumah adat NTT pada gambar tersebut '
  }
];
