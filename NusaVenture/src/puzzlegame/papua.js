const questions = [
  {
    preview: '../assets/img/tariyospanpapua.png',
    pieces: [
      '../assets/img/yospanpapua/puzzle3_1_1.png',
      '../assets/img/yospanpapua/puzzle3_1_2.png',
      '../assets/img/yospanpapua/puzzle3_1_3.png',
      '../assets/img/yospanpapua/puzzle3_2_1.png',
      '../assets/img/yospanpapua/puzzle3_2_2.png',
      '../assets/img/yospanpapua/puzzle3_2_3.png',
      '../assets/img/yospanpapua/puzzle3_3_1.png',
      '../assets/img/yospanpapua/puzzle3_3_2.png',
      '../assets/img/yospanpapua/puzzle3_3_3.png'
    ],
    answer: [
      'puzzle3_1_1.png','puzzle3_1_2.png','puzzle3_1_3.png',
      'puzzle3_2_1.png','puzzle3_2_2.png','puzzle3_2_3.png',
      'puzzle3_3_1.png','puzzle3_3_2.png','puzzle3_3_3.png'
    ],
    question: 'Apa Tarian adat tradisional Papua pada gambar tersebut adalah '
  },
  {
    preview: '../assets/img/wamaipapua.jpg',
    pieces: [
      '../assets/img/wamaipapua/wamai_puzzle_1_1.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_1_2.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_1_3.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_2_1.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_2_2.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_2_3.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_3_1.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_3_2.jpg',
      '../assets/img/wamaipapua/wamai_puzzle_3_3.jpg'
    ],
    answer: [
      'wamai_puzzle_1_1.jpg','wamai_puzzle_1_2.jpg','wamai_puzzle_1_3.jpg',
      'wamai_puzzle_2_1.jpg','wamai_puzzle_2_2.jpg','wamai_puzzle_2_3.jpg',
      'wamai_puzzle_3_1.jpg','wamai_puzzle_3_2.jpg','wamai_puzzle_3_3.jpg'
    ],
    question: 'Apa Rumah adat papua pada gambar tersebut '
  },
  {
    preview: '../assets/img/lontar.jpeg',
    pieces: [
      '../assets/img/lontarpapua/puzzle_piece_1_1.jpg',
      '../assets/img/lontarpapua/puzzle_piece_1_2.jpg',
      '../assets/img/lontarpapua/puzzle_piece_1_3.jpg',
      '../assets/img/lontarpapua/puzzle_piece_2_1.jpg',
      '../assets/img/lontarpapua/puzzle_piece_2_2.jpg',
      '../assets/img/lontarpapua/puzzle_piece_2_2.jpg',
      '../assets/img/lontarpapua/puzzle_piece_3_1.jpg',
      '../assets/img/lontarpapua/puzzle_piece_2_2.jpg',
      '../assets/img/lontarpapua/puzzle_piece_3_3.jpg'
    ],
    answer: [
      'puzzle_piece_1_1.jpg','puzzle_piece_1_2.jpg','puzzle_piece_1_3.jpg',
      'puzzle_piece_2_1.jpg','puzzle_piece_2_2.jpg','puzzle_piece_2_2.jpg',
      'puzzle_piece_3_1.jpg','puzzle_piece_2_2.jpg','puzzle_piece_3_3.jpg'
    ],
    question: 'Apa makakanan tradisional khas Papua pada gambar tersebut '
  }
];
