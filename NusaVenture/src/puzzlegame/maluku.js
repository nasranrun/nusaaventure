const questions = [
  {
    preview: '../assets/img/bajucelemaluku.jpg',
    pieces: [
      '../assets/img/bcelemaluku/piece_1_1.jpg',
      '../assets/img/bcelemaluku/piece_1_2.jpg',
      '../assets/img/bcelemaluku/piece_1_3.jpg',
      '../assets/img/bcelemaluku/piece_2_1.jpg',
      '../assets/img/bcelemaluku/piece_2_2.jpg',
      '../assets/img/bcelemaluku/piece_2_3.jpg',
      '../assets/img/bcelemaluku/piece_3_1.jpg',
      '../assets/img/bcelemaluku/piece_3_2.jpg',
      '../assets/img/bcelemaluku/piece_3_3.jpg'
    ],
    answer: [
    ...
    question: 'Apa baju adat tradisional Maluku pada gambar tersebut adalah '
  },
  {
    preview: '../assets/img/taricakalelemaluku.jpeg',
    pieces: [
      '../assets/img/cakalelemaluku/piece_1_1.jpg',
      '../assets/img/cakalelemaluku/piece_1_2.jpg',
      '../assets/img/cakalelemaluku/piece_1_3.jpg',
      '../assets/img/cakalelemaluku/piece_2_1.jpg',
      '../assets/img/cakalelemaluku/piece_2_2.jpg',
      '../assets/img/cakalelemaluku/piece_2_3.jpg',
      '../assets/img/cakalelemaluku/piece_3_1.jpg',
      '../assets/img/cakalelemaluku/piece_3_2.jpg',
      '../assets/img/cakalelemaluku/piece_3_3.jpg'
    ],
    answer: [
      'piece_1_1.jpg','piece_1_2.jpg','piece_1_3.jpg',
      'piece_2_1.jpg','piece_2_2.jpg','piece_2_3.jpg',
    ...
    question: 'Apa tarian adat tradisional Khas Maluku pada gambar tersebut 🍚'
  },
  {
    preview: '../assets/img/nasilapolamaluku.jpg',
    pieces: [
      '../assets/img/lapolamaluku/piece_1_1.jpg',
      '../assets/img/lapolamaluku/piece_1_2.jpg',
      '../assets/img/lapolamaluku/piece_1_3.jpg',
      '../assets/img/lapolamaluku/piece_2_1.jpg',
      '../assets/img/lapolamaluku/piece_2_2.jpg',
      '../assets/img/lapolamaluku/piece_2_3.jpg',
      '../assets/img/lapolamaluku/piece_3_1.jpg',
      '../assets/img/lapolamaluku/piece_3_2.jpg',
      '../assets/img/lapolamaluku/piece_3_3.jpg'
    ],
    answer: [
      'piece_1_1.jpg','piece_1_2.jpg','piece_1_3.jpg',
      'piece_2_1.jpg','piece_2_2.jpg','piece_2_3.jpg',
    ...
    question: 'Apa makanan tradisional Maluku pada gambar tersebut '
  }
];
...
document.getElementById('btn-kembali').onclick = function() {
  window.location.href = '../pilihangame/maluku.html';
};
